...
public class Main {
    public static void main(String[] args) {
       ...
       //  layout manager = Defines the natural layout for conmponents in a container
        // 3 common managers

        // Border layout = A border layout places components in five areas: NORTH,SOUTH,WEST;EAST,Center
        // all extra place is used in the center of the frame
       ...
       /// sub panels within a caontainer
